...
$compteBancaire1 = new CompteBancaire (1333, "Compte courant", 100, "Dollars", $titulaire1);
...
echo "<br>";
echo $compteBancaire1->addOrWithdraw(50);
echo $compteBancaire1->addOrWithdraw(-125);
echo $compteBancaire1->addOrWithdraw(-26);
